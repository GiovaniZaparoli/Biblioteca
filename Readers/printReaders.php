                    ...
                    <tbody class="">
                        <?php while($usuario = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-dark btn-block" href="removeReaders.php?id=<?php echo $usuario['id']?>">Excluir</a>
                                </td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="updateReaders.php?id=<?php echo $usuario['id']?>">Alterar</a>
                                </td>
                            </tr>
                        <?php }?>
                    </tbody>
