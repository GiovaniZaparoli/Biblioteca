            ...
            <div class="row">
                <div class="offset-md-3 col-md-6 offset-md-3">
                   <div class="d-flex justify-content-center">
                    ...
                    <form action="inputReaders.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputCpf" name="cpf" placeholder="Informe seu CPF sem pontos ou traços(somente números)." required>
                        </div>
