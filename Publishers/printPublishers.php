        ...
        <div class="row">
            <div class="offset-md-2 col-md-8 offset-md-2">
                ...
                <table class="table table-dark mt-2 text-center">
                    ...
                    <tbody class="">
                        <?php while($usuario = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $usuario['name']?></td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Publishers/removePublisher.php?id=<?php echo $usuario['id']?>">
                                        Excluir
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Publishers/updatePublisher.php?id=<?php echo $usuario['id']?>">
                                        Alterar
                                    </a>
                                </td>
                            </tr>
