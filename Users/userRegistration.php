                   ...
                   <div class="d-flex justify-content-center">
                    ...
                    <form action="inputUsers.php" method="POST">
                        <div class="form-group">
                            ...
                            placeholder="Você usurá este nome para logar no sistema." required>
                        </div>

                        <div class="form-group">
                            <label for="inputCpf">CPF</label>
                            <input type="text" class="form-control" id="inputCpf" name="cpf"
                            placeholder="Informe seu CPF sem pontos ou traços(somente números)." required>
                        </div>

                        <div class="form-group">
                            <label for="inputDataNascimento">Data de Nascimento</label>
                            <input type="date" class="form-control" id="inputDataNascimento" name="birthDate" placeholder="Informe sua data de nascimento." required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="inputPassword" name="password" placeholder="Digite sua senha." required>
                        </div>
