        ...
        <div class="row">
            <div class="offset-md-2 col-md-8 offset-md-2">
                ...
                <table class="table table-dark mt-2 text-center">
                    ...
                    <tbody class="">
                        <?php while($genero = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $genero['name']?></td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Genres/removeGenre.php?id=<?php echo $genero['id']?>">  
                                        Excluir
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Genres/updateGenres.php?id=<?php echo $genero['id']?>">  
                                        Alterar
                                    </a>
                                </td>
                            </tr>
