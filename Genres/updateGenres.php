<?php
    ...
    $genre = new Genre();
    $genre->setId($_GET['id']);
    $genero = mysqli_fetch_array($genre->selectOne(), MYSQLI_ASSOC);
    $_SESSION['name'] = $genero['name']; 
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Atualização de genêros</title>
            ...
            <div class="row">
                <div class="offset-md-3 col-md-6 offset-md-3">
                    <div class="d-flex justify-content-center mb-3">
                        <h1>Alterar dados do genêro</h1>
                    </div>

                    <form action="alterGenre.php" method="POST">
