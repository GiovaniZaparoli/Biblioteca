<?php
    ...
    $author = new Author();
    $author->setName($_POST['name'] ?? null);
    if($author->insert()){
        $_SESSION['menssagem'] = 'Autor cadastrado com sucesso!';
    }
    else{
        $_SESSION['menssagem'] = 'Falha ao cadastrar autor!';
    }    
?>
<!DOCTYPE html>
<html>
        ...
        <div class="row">
            <div class="offset-md-3 col-md-6 offset-md-3">
                ...
                <div class="d-flex justify-content-center ">
                    <a href="authorRegistration.php"><button class="btn btn-dark mb-5">Cadastrar novo autor</button></a>
                </div>
            </div>
        </div>
    </div>                
