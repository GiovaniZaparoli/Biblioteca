        ...
        <div class="row">
            <div class="offset-md-2 col-md-8 offset-md-2">
                ...
                <table class="table table-dark mt-2 text-center">
                    ...
                    <tbody class="">
                        <?php while($authors = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $authors['name']?></td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Authors/removeAuthors.php?id=<?php echo $authors['id']?>">
                                        Excluir
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="/Authors/updateAuthors.php?id=<?php echo $authors['id']?>">
                                        Alterar
                                    </a>
                                </td>
                            </tr>
