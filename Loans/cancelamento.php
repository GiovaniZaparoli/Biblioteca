...
<head>
    ...
    <title>Cancelamento de empréstimos</title>
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <form action="cancellation.php" method="POST">
                            <div class="form-group">
                                <label for="inputUsuario">Data de Cancelamento</label>
                                <input type="date" class="form-control" id="inputDate" name="dataCancelamento" aria-describedby="userHelp" required>
                            </div>              
                            <input type="hidden" name="id" value="<?php echo $loan->getLoanId()?>">
                            <button type="submit" name="enviar" value="enviar" class="btn btn-dark d-flex justify-content-center mb-5">Cancelar Empréstimo</button>
                        </form>
                    </div>
                </div>
            </div>
