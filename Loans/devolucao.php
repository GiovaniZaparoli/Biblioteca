            ...
            <div class="row">
                <div class="offset-md-3 col-md-6 offset-md-3">
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <form action="devolution.php" method="POST">
                            <div class="form-group">
                                <label for="inputUsuario">Data de Devolução</label>
                                <input type="date" class="form-control" id="inputDate" name="dataDevolucao" aria-describedby="userHelp" required>
                            </div>              
                            <input type="hidden" name="id" value="<?php echo $loan->getLoanId()?>">
                            <button type="submit" name="enviar" value="enviar" class="btn btn-dark d-flex justify-content-center mb-5">Devolver livro</button>
                        </form>
                    </div>
                </div>
            </div>
