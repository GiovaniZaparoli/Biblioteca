        ...
        <div class="row">
            <div class="offset-md-2 col-md-8 offset-md-2">
                ...
                <table class="table table-dark mt-2 text-center">
                    ...
                    <tbody class="">
                        <?php while($livro = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $livro['title']?></td>
                                <td><?php echo date('d/m/Y', strtotime($livro['publication_date']))?></td>
                                <td><?php echo $livro['autor']?></td>
                                <td><?php echo $livro['genres']?></td>
                                <td><?php echo $livro['publisher']?></td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="removeBooks.php?id=<?php echo $livro['id']?>">
                                        Excluir
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-dark btn-block" href="updateBooks.php?id=<?php echo $livro['id']?>">  
                                        Alterar
                                    </a>
                                </td>
                            </tr>
