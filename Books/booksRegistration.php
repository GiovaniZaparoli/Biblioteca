            ...
            <div class="row">
                <div class="offset-md-3 col-md-6 offset-md-3">
                   <div class="d-flex justify-content-center">
                    ...
                    <form action="inputBooks.php" method="POST">
                        <div class="form-group">
                            <label for="inputTitulo">Título</label>
                            <input type="text" class="form-control" id="inputTitulo" name="titulo" aria-describedby="userHelp"
                            placeholder="Título do livro" required>
                        </div>
                        <div class="form-group">
                            <label for="inputDataPublicacao">Data de Publicação</label>
                            <input type="date" class="form-control" id="inputDataPublicacao" name="dataPublicacao" aria-describedby="userHelp"
                            placeholder="Data de Publicação" required>
                        </div>
                        <div class="form-group">
                            <label for="inputAutor">Autor</label>
                            <select required name="idAuthor" id="inputAutor" class="form-control">
                            <?php while($usuario = mysqli_fetch_array($resultadoAutor, MYSQLI_ASSOC)) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <select required name="idGenre" id="inputGenre" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select required name="idPublisher" id="inputEditora" class="form-control">
                        ...
                        <button type="submit" name="enviar" value="enviar" class="btn btn-dark d-flex justify-content-center mb-5">Cadastrar</button>
                    </form>
                </div>
            </div>
        </div>
