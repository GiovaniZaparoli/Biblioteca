...
<body>
    <section class="header-home">
        <div class="container-fluid d-flex justify-content-center">
            <div class="row">
                <div class="offset-md-2 col-md-6 offset-md-2">
            ...
            <div class="offset-md-4 col-md-4 offset-md-4">
                <form class="mt-5" method="POST" action="login.php">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputUsuario" name="login" aria-describedby="userHelp" placeholder="Informe o usuário do sistema.">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group d-flex justify-content-center">
                        ...
                        <input type="hidden" value="entrar" id="entrar" name="entrar"><br>
                    </div>
                </form>
            </div>
        </div>
