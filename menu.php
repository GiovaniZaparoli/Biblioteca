...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                    <div>
                        <h1 class=""><?php echo"Bem vindo $login_cookie <br>"; ?></h1>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <main class="container my-5">
        <div class="row">
            <div class="offset-md-2 col-md-8 offset-md-2 d-flex justify-content-center">
                <h5 class="text-center mt-5">Este sistema permite o cadastros de usuários, clientes, livros,
                    autores e editoras, a alteração ou exclusão dos mesmos, também podemos fazer empréstimos, assim como cancelar
                    os mesmos e efetuar a devolução, além de vários relatórios.</h5>
            </div>
        </div>
    </main>
