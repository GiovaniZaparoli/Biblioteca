        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-center mt-4">
                    <h1>Listagem dos leitores que mais retiram livros</h1>
                </div>
                <table class="table table-dark mt-2 text-center">
                    <thead>
                        <tr>
                            <th scope="col">Nome do leitor</th>
                            <th scope="col">livros retirados</th>
                        </tr>
                    </thead>
                    <tbody class="">
                        <?php while($user = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $user['name']?></td>
                                <td><?php echo $user['leitores']?></td>
                            </tr>
                        <?php }?>
                    </tbody>
                </table>
