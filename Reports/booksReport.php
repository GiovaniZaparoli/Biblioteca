        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-center mt-4">
                    <h1>Listagem dos livros mais emprestados</h1>
                </div>
                <table class="table table-dark mt-2 text-center">
                    <thead>
                        <tr>
                            <th scope="col">Número de empréstimos</th>
                            <th scope="col">Titulo do livro</th>
                        </tr>
                    </thead>
                    <tbody class="">
                        <?php while($loan = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td><?php echo $loan['livro']?></td>
